...
Config::Config() {
  ...
  // if (chipInfo.get_ChipName() == "3DV7" ||
  //     chipInfo.get_ChipName() == "X3_9070"){
  //   page = chipInfo.get_PageNum();
  //   pageSize = chipInfo.get_PageSize();
  // }
  ...
  nandTiming.csb.read = 40000000;
  nandTiming.csb.write = 500000000;
  nandTiming.msb.read = 40000000;     // 40us
  nandTiming.msb.write = 500000000;  // 500us
