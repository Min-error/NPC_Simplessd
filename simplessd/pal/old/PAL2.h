...
class PAL2  // let's not inherit PAL1
{
 public:
  ...
  void submit(Command &cmd, CPDPBP &addr, uint32_t pageIndex = 0);
//   void submit(Command &cmd, CPDPBP &addr, uint32_t pageIndex);
  void TimelineScheduling(Command &req, CPDPBP &reqCPD, uint32_t pageIndex = 0);
//   void TimelineScheduling(Command &req, CPDPBP &reqCPD, uint32_t pageIndex);
