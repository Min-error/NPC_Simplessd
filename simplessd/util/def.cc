...
Request::_Request() : reqID(0), reqSubID(0), offset(0), length(0), isWLGranularity(false) {}
...
Request::_Request(uint32_t iocount)
    : reqID(0), reqSubID(0), lpn(0), ioFlag(iocount), isWLGranularity(false) {}
...
Request::_Request(uint32_t iocount, ICL::Request &r)
    : reqID(r.reqID),
      ...
      ioFlag(iocount),
      isWLGranularity(r.isWLGranularity) {
