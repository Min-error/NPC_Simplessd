...
class Config : public BaseConfig {
 private:
  ...
  bool tlcWLEnable;            //!< Default: true
  uint32_t tlcWLSize;          //!< Default: 3
  uint32_t ftlIndex;           //!< Default: 1
  uint64_t coldDataThreshold;  //!< Default: 131072 (128KB)
